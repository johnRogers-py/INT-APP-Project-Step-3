...
function NavBar({ cartCount, searchQuery, onSearchChange, onCartToggle, categories, activeCategory, onCategoryChange }) {
  return (
    <header className={styles.header}>
      ...
      <nav className={styles.primaryNav} aria-label="Primary navigation">
        <div className={styles.primaryInner}>
          ...
          {/* Returns & Orders */}
          <button className={styles.navBtn} aria-label="Returns and orders">
